...
sudo cp -r /home/$USER/arch-calamares/3.3.14.5/distros/plain/calamares /etc
sudo cp -r /home/$USER/arch-calamares/3.3.14.5/distros/plain/claudemods /usr/share/calamares/branding
